...
return this.promisizer(jQuery.sap.getModulePath("ExposicionSelectInfo") + "/localService/" + sJsonName);
},
...
getShippers: function() {
    let oRequest = this.getRequest({
        endPoint: "Northwind",
        method: "GET",
        entity: Constants.entity.shippers

    });
    return this.promisizer(oRequest);
},

getShippersDetail: function(id) {
    let oRequest = this.getRequest({
        endPoint: "Northwind",
        method: "GET",
        entity: Constants.entity.shippers + "(" + id + ")"
...
return jQuery.sap.getModulePath("ExposicionSelectInfo.ExposicionSelectInfo") + "/";
},
